          ...
          <div className="md:w-[40vw] w-full h-screen md:p-[1vw] p-[1vh] bg-[#f5f5f5d5] dark:bg-zinc-700 md:rounded-xl md:min-h-[20vw] md:max-h-[90vh] popup-animate ">
            <div className="flex items-center justify-between gap-2">
              ...
              <input
                ...
                className="w-full placeholder:text-zinc-700 dark:placeholder:text-zinc-200 outline-none md:pl-[1vw] md:pr-[4vw] md:py-[.3vw] pl-[1.5vh] pr-[6vh] py-[.5vh] rounded-full md:rounded-xl border-2 border-zinc-400 dark:border-zinc-600 text-zinc-700 dark:text-zinc-200 bg-transparent text-[1.7vh] md:text-[1vw]"
              />
            </div>
          </div>
        </div>
